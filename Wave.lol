...
gui.blazedLoader:Destroy()
    ...
    function Notifications(NotiINFO)
        if getgenv().NotiMode == "Roblox" then
            game:GetService("StarterGui"):SetCore("SendNotification",{
                Title = "Wave.lol", -- Required
                Text = NotiINFO, -- Required
                Icon = "rbxassetid://287003766" -- Optional
            })
        else
    ...
    if game.PlaceId == 2788229376 or game.PlaceId == 2788229376 or game.PlaceId == 2788229376 then 
